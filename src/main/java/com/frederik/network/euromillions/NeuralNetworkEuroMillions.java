package com.frederik.network.euromillions;
...
/**
 * 
 * https://www.nationale-loterij.be/nl/onze-spelen/euromillions/resultaten?date=14-10-2016#
 * 
 * @author ja43705
 *
 */
public class NeuralNetworkEuroMillions {
	
	private double [] weights_neuron1 = new double [51];
	private double [] weights_neuron2 = new double [51];
	...
	private double [] weights_neuron11 = new double [3];
	
	private double lambda = 0; 
	private double alpha = 0.5; // learning reate
